...
# Merge: salesitems + items + sales (for saletime)
...
# Prepare group label, replacing NaN/blank with "Unknown"
if GROUP_KEY not in merged.columns:
    merged[GROUP_KEY] = "Unknown"
...
# If there is no data, show message instead of blank
if top_groups.empty:
